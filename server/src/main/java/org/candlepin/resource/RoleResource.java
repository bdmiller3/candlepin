...
public class RoleResource {
    ...
    public RoleDTO updateRole(@PathParam("role_name") String roleName,
        ...
        // Make sure the role's name matches the one we intend to update, since the service uses the
        // role name to make changes.
        dto.setName(roleName);

        RoleInfo role = this.userService.updateRole(dto);
        return this.modelTranslator.translate(role, RoleDTO.class);
    }
